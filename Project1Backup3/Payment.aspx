...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:HiddenField ID="hdPidVarientID" runat="server" />
            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                ...
                <div id="cards" class="tab-pane fade">
                    <h3>Cards</h3>
                    <p></p>
                     <asp:Button ID="btnCards" OnClick="btnPaytm_Click" runat="server" Text="Pay with Cards" />
                </div>
                <div id="cod" class="tab-pane fade">
                    <h3>Cash on Delivery</h3>
                    <p></p>
                     <asp:Button ID="btnCash" OnClick="btnPaytm_Click" runat="server" Text="Pay Cash on Delivery" />
                </div>
            </div>
             ...
             <div class="tab-content">
                                ...
                                <div id="EPaisa" class="tab-pane fade">
                                    <h3 class="center1">EPaisa Payment Gateway Coming Soon</h3>  -->
                                ...
                                <div id="ECash" class="tab-pane fade">
                                  <!---   <h3 class="center1">ECash Payment Gateway Coming Soon</h3>
