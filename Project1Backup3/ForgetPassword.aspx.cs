...
public partial class ForgetPassword : System.Web.UI.Page
{
    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from tblUse where Email=@Email", con);
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "hi," + Username + ",<br/><br/>Click the link below to reset your password<br/><br/> http://localhost:51264/RecoverPassword.aspx?id=" + myGUID;
