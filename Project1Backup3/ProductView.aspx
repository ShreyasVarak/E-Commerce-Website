...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <%# GetActiveImgClass(Container.ItemIndex) %>">
      <img src="ProductImages/<%# Eval("PID") %>/<%# Eval("Name") %><%# Eval("Extension") %>" alt="<%# Eval("Name") %>" onerror="this.src='Images/ImageNotAvailable.jpg'">
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div >
                <h5 class="h5size"> VARIANT </h5>
                <div>
                    <asp:radiobuttonlist ID="rblVarient" runat="server" RepeatDirection="Horizontal" >
                       <asp:ListItem value="4gb Ram" Text="4gb Ram"></asp:ListItem>
                        <asp:ListItem value="6gb Ram" Text="6gb Ram"></asp:ListItem>
                        <asp:ListItem value="8gb Ram" Text="8gb Ram"></asp:ListItem>  
                    </asp:radiobuttonlist>
                </div>
            </div>
            <div class="divDet1">
